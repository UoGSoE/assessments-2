<div>
    ...
    <div class="space-y-6">
        <form action="{{ route('import.upload', ['type' => 'submission-windows']) }}" method="post"
            ...
            <flux:text><strong>Please note:</strong> this will only import submission windows, not deadlines.
            </flux:text>
            <flux:text>For importing deadlines, please use the <a class="text-blue-500"
                    href="{{ route('import.deadlines.show') }}"> Deadlines Import page.</a></flux:text>
            <flux:text>If the course code, staff email and assessment type is the same as an existing submission window,
                then the submission window date will be updated.</flux:text>
